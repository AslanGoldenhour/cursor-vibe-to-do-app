...
export default function Navbar() {
  ...
  return (
    <nav className="w-full bg-white dark:bg-gray-800 shadow-md py-4 px-6 flex justify-between items-center">
      <div className="text-xl font-bold text-blue-600 dark:text-blue-400">Cursor Vibe Todo</div>
